              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600">
                    {userStats.totalPages.toLocaleString()}
                  </div>
              ...
              <div className="mt-4 pt-4 border-t">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium">
                    {userStats.booksRead} / {preferences.readingGoal} books
                  </span>
                </div>
                <div className="mt-2 bg-gray-200 rounded-full h-2">
                  <div
                    ...
                    style={{
                      width: `${Math.min(
                        (userStats.booksRead / preferences.readingGoal) * 100,
                        100
                      )}%`,
                    }}
                  />
            ...
            <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {lengthOptions.map((option) => (
                    <button
                      ...
                      onClick={() =>
                        isEditing &&
                        handlePreferenceChange("preferredLength", option.value)
                      }
                      disabled={!isEditing}
                      className={`px-3 py-2 text-sm rounded-lg border transition-colors ${
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  {contentWarningOptions.map((warning) => (
                    <button
                      key={warning}
                      onClick={() =>
                        isEditing && handleContentWarningToggle(warning)
                      }
                      disabled={!isEditing}
                      className={`px-3 py-2 text-sm rounded-lg border transition-colors ${
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handlePreferenceChange("languagePreference", e.target.value)
                  }
                  disabled={!isEditing}
